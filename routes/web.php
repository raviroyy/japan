...
//Route::get('home',function(){})->middleware('RedirectToAppropriateHome')->name('admin.home');
Route::get('home',[HomeController::class,'home'])->middleware(RedirectToAppropriateHome::class);
